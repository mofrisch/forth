...
\ Author: Anton Ertl
\ Copyright (C) 2003,2004,2005,2006,2007,2008,2019 Free Software Foundation, Inc.
...
\ Copyright (C) 2003,2004,2005,2007,2010,2012,2013,2015,2016,2019 Free Software Foundation, Inc.
...
swapwfetch = uw@ w><
swaplfetch = ul@ l><
\ cswapxfatch = ux@ x>< \ only on 64 bits
csswapwfetch = uw@ w>< w>s
csswaplfetch = ul@ l>< l>s
