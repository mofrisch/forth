...
N_get_gforth_pointers, /* gforth-pointers */
GROUPADD(20)
#endif
GROUPADD(0)
#ifdef HAS_FILE
...
N_sfloat_divide, /* dfloat/ */
N_dfloat_divide, /* sfloat/ */
N_f_not_rote, /* f-rot */
N_flit, /* flit */
GROUPADD(81)
#endif
...
N_u_xd_fetch, /* uxd@ */
N_s_xd_fetch, /* sxd@ */
N_b_e_xd_store, /* be-xd! */
N_l_e_xd_store, /* le-xd! */
N_b_e_u_xd_fetch, /* be-uxd@ */
N_l_e_u_xd_fetch, /* le-uxd@ */
N_wordswap, /* w>< */
N_longswap, /* l>< */
N_extralongswap, /* x>< */
N_extralongdswap, /* xd>< */
...
N_finish_code_barrier, /* finish-code| */
GROUPADD(6)
#endif
GROUPADD(0)
...
N_lit_fetch,N_and, /* super19 */
N_useraddr,N_store, /* super23 */
N_fetch,N_semis, /* super25 */
N_lit_fetch,N_plus, /* super26 */
N_dupe,N_fetch, /* super27 */
N_o_lit_plus,N_fetch, /* super29 */
N_o_lit_plus,N_store, /* super30 */
N_lit,N_f_fetch, /* super31 */
N_lit,N_f_store, /* super32 */
N_noop,N_flit, /* super33 */
N_lit_plus,N_fetch, /* super34 */
N_f_fetch,N_f_star, /* super35 */
N_f_fetch,N_f_plus, /* super36 */
N_lit,N_and, /* super37 */
N_lit,N_ar_shift, /* super38 */
N_dupe,N_lit,N_and,N_swap, /* super39 */
N_to_l,N_to_l, /* super40 */
N_zero_less_than,N_question_branch, /* cb1 */
N_zero_less_or_equal,N_question_branch, /* cb2 */
N_zero_not_equals,N_question_branch, /* cb3 */
N_zero_equals,N_question_branch, /* cb4 */
N_zero_greater_than,N_question_branch, /* cb5 */
N_zero_greater_or_equal,N_question_branch, /* cb6 */
N_less_than,N_question_branch, /* cb7 */
N_less_or_equal,N_question_branch, /* cb8 */
N_not_equals,N_question_branch, /* cb9 */
N_equals,N_question_branch, /* cb10 */
N_greater_than,N_question_branch, /* cb11 */
N_greater_or_equal,N_question_branch, /* cb12 */
N_d_zero_equals,N_question_branch, /* cb13 */
N_d_less_than,N_question_branch, /* cb14 */
N_d_equals,N_question_branch, /* cb15 */
N_f_less_than,N_question_branch, /* cb16 */
N_f_equals,N_question_branch, /* cb17 */
N_u_less_than,N_question_branch, /* cb18 */
N_u_less_or_equal,N_question_branch, /* cb19 */
N_u_greater_than,N_question_branch, /* cb20 */
N_u_greater_or_equal,N_question_branch, /* cb21 */
N_within,N_question_branch, /* cb22 */
N_c_fetch,N_char_sext, /* cscfetch */
N_u_w_fetch,N_word_sext, /* cswfetch */
N_u_l_fetch,N_long_sext, /* cslfetch */
N_u_w_fetch,N_wordswap, /* swapwfetch */
N_u_l_fetch,N_longswap, /* swaplfetch */
N_u_w_fetch,N_wordswap,N_word_sext, /* csswapwfetch */
N_u_l_fetch,N_longswap,N_long_sext, /* csswaplfetch */
GROUPADD(52)
GROUP( end, 499)
