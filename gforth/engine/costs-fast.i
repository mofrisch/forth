...
{ 2, 2, 2, 1 , 0, 0,3,N_START_SUPER+    0, 2}, /* super2 */
{ 2, 0, 1, 0 , 0, 0,2,N_START_SUPER+    2, 2}, /* super6 */
{ 3, 0, 2, 1 , 0, 0,1,N_START_SUPER+    4, 2}, /* super11 */
{ 1, 1, 1, 0 , 0, 0,2,N_START_SUPER+    6, 2}, /* super15 */
{ 2, 1, 1, 0 , 0, 0,1,N_START_SUPER+    8, 2}, /* super16 */
{ 3, 0, 2, 1 , 0, 0,3,N_START_SUPER+   10, 3}, /* super18 */
{ 2, 1, 0, 0 , 0, 0,2,N_START_SUPER+   13, 2}, /* super19 */
{ 2, 0, 1, 0 , 0, 0,2,N_START_SUPER+   15, 2}, /* super23 */
{ 2, 1, 1, 1 , 0, 0,1,N_START_SUPER+   17, 2}, /* super25 */
{ 2, 1, 0, 0 , 0, 0,2,N_START_SUPER+   19, 2}, /* super26 */
{ 1, 2, 1, 0 , 0, 0,1,N_START_SUPER+   21, 2}, /* super27 */
{ 1, 1, 1, 0 , 0, 0,2,N_START_SUPER+   23, 2}, /* super29 */
{ 2, 0, 1, 0 , 0, 0,2,N_START_SUPER+   25, 2}, /* super30 */
{ 1, 1, 1, 0 , 0, 0,2,N_START_SUPER+   27, 2}, /* super31 */
{ 2, 0, 1, 0 , 0, 0,2,N_START_SUPER+   29, 2}, /* super32 */
{ 0, 1, 1, 0 , 0, 0,1,N_START_SUPER+   31, 2}, /* super33 */
{ 2, 1, 0, 0 , 0, 0,2,N_START_SUPER+   33, 2}, /* super34 */
{ 2, 1, 1, 0 , 0, 0,1,N_START_SUPER+   35, 2}, /* super35 */
{ 2, 1, 1, 0 , 0, 0,1,N_START_SUPER+   37, 2}, /* super36 */
{ 2, 1, 0, 0 , 0, 0,2,N_START_SUPER+   39, 2}, /* super37 */
{ 2, 1, 0, 0 , 0, 0,2,N_START_SUPER+   41, 2}, /* super38 */
{ 2, 2, 1, 0 , 0, 0,4,N_START_SUPER+   43, 4}, /* super39 */
{ 2, 0, 1, 0 , 0, 0,1,N_START_SUPER+   47, 2}, /* super40 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   49, 2}, /* cb1 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   51, 2}, /* cb2 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   53, 2}, /* cb3 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   55, 2}, /* cb4 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   57, 2}, /* cb5 */
{ 2, 0, 1, 1 , 0, 0,2,N_START_SUPER+   59, 2}, /* cb6 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   61, 2}, /* cb7 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   63, 2}, /* cb8 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   65, 2}, /* cb9 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   67, 2}, /* cb10 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   69, 2}, /* cb11 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   71, 2}, /* cb12 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   73, 2}, /* cb13 */
{ 5, 0, 1, 1 , 0, 0,2,N_START_SUPER+   75, 2}, /* cb14 */
{ 5, 0, 1, 1 , 0, 0,2,N_START_SUPER+   77, 2}, /* cb15 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   79, 2}, /* cb16 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   81, 2}, /* cb17 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   83, 2}, /* cb18 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   85, 2}, /* cb19 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   87, 2}, /* cb20 */
{ 3, 0, 1, 1 , 0, 0,2,N_START_SUPER+   89, 2}, /* cb21 */
{ 4, 0, 1, 1 , 0, 0,2,N_START_SUPER+   91, 2}, /* cb22 */
{ 1, 1, 0, 0 , 0, 0,1,N_START_SUPER+   93, 2}, /* cscfetch */
{ 1, 1, 0, 0 , 0, 0,1,N_START_SUPER+   95, 2}, /* cswfetch */
{ 1, 1, 0, 0 , 0, 0,1,N_START_SUPER+   97, 2}, /* cslfetch */
{ 1, 1, 0, 0 , 0, 0,1,N_START_SUPER+   99, 2}, /* swapwfetch */
{ 1, 1, 0, 0 , 0, 0,1,N_START_SUPER+  101, 2}, /* swaplfetch */
{ 1, 1, 0, 0 , 0, 0,2,N_START_SUPER+  103, 3}, /* csswapwfetch */
{ 1, 1, 0, 0 , 0, 0,2,N_START_SUPER+  106, 3}, /* csswaplfetch */
{-1, 1, 1, 0 , 1, 0,1,N_lit, 1}, /* lit */
{-1, 1, 1, 0 , 1, 0,1,N_lit_fetch, 1}, /* lit@ */
{-1, 2, 1, 0 , 1, 0,0,N_dupe, 1}, /* dup */
{ 1, 2, 1, 0 , 0, 1,0,N_under_plus, 1}, /* under+ */
{-1, 2, 1, 0 , 1, 0,0,N_i, 1}, /* i */
{-1, 1, 1, 0 , 1, 0,1,N_useraddr, 1}, /* useraddr */
{ 0, 3, 1, 0 , 1, 0,0,N_over, 1}, /* over */
{ 0, 4, 1, 0 , 1, 0,0,N_two_dupe, 1}, /* 2dup */
{-1, 0, 1, 0 , 0, 1,0,N_drop, 1}, /* drop */
{-1, 0, 1, 0 , 1, 1,0,N_drop, 1}, /* drop */
{-1, 1, 2, 0 , 0, 1,0,N_to_r, 1}, /* >r */
{-1, 1, 2, 0 , 1, 0,0,N_r_from, 1}, /* r> */
{-1, 0, 0, 0 , 1, 1,1,N_lp_plus_store_number, 1}, /* lp+!# */
{ 0, 0, 1, 0 , 1, 1,0,N_unloop, 1}, /* unloop */
{-2, 0, 0, 0 , 1, 1,0,N_lp_plus, 1}, /* lp+ */
{-2, 1, 1, 0 , 1, 0,0,N_fetch_local_zero, 1}, /* @local0 */
{ 0, 1, 1, 0 , 1, 0,0,N_nip, 1}, /* nip */
{-2, 0, 0, 0 , 1, 1,0,N_lp_minus, 1}, /* lp- */
{-1, 1, 1, 0 , 1, 0,1,N_fetch_local_number, 1}, /* @local# */
{ 0, 0, 1, 0 , 1, 1,0,N_two_drop, 1}, /* 2drop */
{ 0, 0, 1, 0 , 0, 1,0,N_two_drop, 1}, /* 2drop */
{-2, 1, 1, 0 , 1, 0,0,N_fetch_local_eight, 1}, /* @local2 */
{-1, 0, 1, 0 , 1, 1,0,N_rdrop, 1}, /* rdrop */
{-2, 1, 1, 0 , 1, 0,0,N_fetch_local_four, 1}, /* @local1 */
{ 0, 3, 1, 0 , 1, 0,0,N_i_tick, 1}, /* i' */
{-1, 1, 1, 0 , 1, 0,1,N_laddr_number, 1}, /* laddr# */
{ 1, 4, 1, 0 , 1, 0,0,N_j, 1}, /* j */
{ 0, 0, 1, 0 , 1, 1,0,N_two_r_drop, 1}, /* 2rdrop */
{-1, 1, 2, 0 , 0, 1,0,N_f_fetch, 1}, /* f@ */
{ 0, 1, 1, 0 , 1, 1,0,N_f_plus, 1}, /* f+ */
{ 0, 1, 1, 0 , 1, 1,0,N_f_star, 1}, /* f* */
{ 0, 0, 2, 0 , 0, 1,0,N_f_store, 1}, /* f! */
{-1, 0, 1, 0 , 0, 1,0,N_to_l, 1}, /* >l */
{-1, 0, 0, 0 , 1, 1,1,N_abi_call, 1}, /* abi-call */
{-1, 0, 0, 0 , 1, 1,1,N_semi_abi_code_exec, 1}, /* ;abi-code-exec */
{-2, 0, 0, 0 , 0, 1,0,N_noop, 1}, /* noop */
{-2, 0, 0, 0 , 1, 0,0,N_noop, 1}, /* noop */
GROUPADD(52)
GROUP( end, 499)
