...
int main( int argc, char **argv )
{
	...
	swigCallback( "c-callback png_rw_ptr: a a n -- void", "", "", "	( <noname> <noname> <noname> -- )" );
	...
	swigCallback( "c-callback png_malloc_ptr: a n -- a", "", "", "	( <noname> <noname> -- )" );
	...
	swigFunction( "c-function png_sig_cmp png_sig_cmp a n n -- n", "FUNCTION: png_sig_cmp ( sig start num_to_check -- n )", "EXTERN: \"C\" int png_sig_cmp( void * sig, n start, n num_to_check );", "	( sig start num_to_check -- )" );
	...
	swigFunction( "c-function png_get_compression_buffer_size png_get_compression_buffer_size a -- n", "FUNCTION: png_get_compression_buffer_size ( png_ptr -- n )", "EXTERN: \"C\" n png_get_compression_buffer_size( void * png_ptr );", "	( png_ptr -- )" );
	swigFunction( "c-function png_set_compression_buffer_size png_set_compression_buffer_size a n -- void", "FUNCTION: png_set_compression_buffer_size ( png_ptr size -- void )", "EXTERN: \"C\" void png_set_compression_buffer_size( void * png_ptr, n size );", "	( png_ptr size -- )" );
	...
	swigFunction( "c-function png_write_chunk png_write_chunk a a a n -- void", "FUNCTION: png_write_chunk ( png_ptr chunk_name data length -- void )", "EXTERN: \"C\" void png_write_chunk( void * png_ptr, void * chunk_name, void * data, n length );", "	( png_ptr chunk_name data length -- )" );
	...
	swigFunction( "c-function png_write_chunk_data png_write_chunk_data a a n -- void", "FUNCTION: png_write_chunk_data ( png_ptr data length -- void )", "EXTERN: \"C\" void png_write_chunk_data( void * png_ptr, void * data, n length );", "	( png_ptr data length -- )" );
	...
	swigFunction( "c-function png_info_init_3 png_info_init_3 a n -- void", "FUNCTION: png_info_init_3 ( info_ptr png_info_struct_size -- void )", "EXTERN: \"C\" void png_info_init_3( void * info_ptr, n png_info_struct_size );", "	( info_ptr png_info_struct_size -- )" );
	...
	swigFunction( "c-function png_malloc png_malloc a n -- a", "FUNCTION: png_malloc ( png_ptr size -- a )", "EXTERN: \"C\" void * png_malloc( void * png_ptr, n size );", "	( png_ptr size -- )" );
	swigFunction( "c-function png_calloc png_calloc a n -- a", "FUNCTION: png_calloc ( png_ptr size -- a )", "EXTERN: \"C\" void * png_calloc( void * png_ptr, n size );", "	( png_ptr size -- )" );
	swigFunction( "c-function png_malloc_warn png_malloc_warn a n -- a", "FUNCTION: png_malloc_warn ( png_ptr size -- a )", "EXTERN: \"C\" void * png_malloc_warn( void * png_ptr, n size );", "	( png_ptr size -- )" );
	...
	swigFunction( "c-function png_get_rowbytes png_get_rowbytes a a -- n", "FUNCTION: png_get_rowbytes ( png_ptr info_ptr -- n )", "EXTERN: \"C\" n png_get_rowbytes( void * png_ptr, void * info_ptr );", "	( png_ptr info_ptr -- )" );
