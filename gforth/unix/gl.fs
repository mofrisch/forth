...
#20190911	constant GL_GLEXT_VERSION
...
\ c-function glRenderbufferStorageMultisampleAdvancedAMD glRenderbufferStorageMultisampleAdvancedAMD u n n u n n -- void	( target samples storageSamples internalformat width height -- )
\ c-function glNamedRenderbufferStorageMultisampleAdvancedAMD glNamedRenderbufferStorageMultisampleAdvancedAMD u n n u n n -- void	( renderbuffer samples storageSamples internalformat width height -- )
...
c-function glEGLImageTargetTexStorageEXT glEGLImageTargetTexStorageEXT u a a -- void	( target image attrib_list -- )
c-function glEGLImageTargetTextureStorageEXT glEGLImageTargetTextureStorageEXT u a a -- void	( texture image attrib_list -- )
...
c-function glFramebufferFetchBarrierEXT glFramebufferFetchBarrierEXT  -- void	( -- )
...
\ c-function glFramebufferParameteriMESA glFramebufferParameteriMESA u u n -- void	( target pname param -- )
\ c-function glGetFramebufferParameterivMESA glGetFramebufferParameterivMESA u u a -- void	( target pname params -- )
...
\ c-function glUploadGpuMaskNVX glUploadGpuMaskNVX u -- void	( mask -- )
\ c-function glMulticastViewportArrayvNVX glMulticastViewportArrayvNVX u u n a -- void	( gpu first count v -- )
\ c-function glMulticastViewportPositionWScaleNVX glMulticastViewportPositionWScaleNVX u u r r -- void	( gpu index xcoeff ycoeff -- )
\ c-function glMulticastScissorArrayvNVX glMulticastScissorArrayvNVX u u n a -- void	( gpu first count v -- )
\ c-function glAsyncCopyBufferSubDataNVX glAsyncCopyBufferSubDataNVX n a a u u u u n n n n a a -- u	( waitSemaphoreCount waitSemaphoreArray fenceValueArray readGpu writeGpuMask readBuffer writeBuffer readOffset writeOffset size signalSemaphoreCount signalSemaphoreArray signalValueArray -- )
\ c-function glAsyncCopyImageSubDataNVX glAsyncCopyImageSubDataNVX n a a u u u u n n n n u u n n n n n n n n a a -- u	( waitSemaphoreCount waitSemaphoreArray waitValueArray srcGpu dstGpuMask srcName srcTarget srcLevel srcX srcY srcZ dstName dstTarget dstLevel dstX dstY dstZ srcWidth srcHeight srcDepth signalSemaphoreCount signalSemaphoreArray signalValueArray -- )
...
\ c-function glCreateProgressFenceNVX glCreateProgressFenceNVX  -- u	( -- )
\ c-function glSignalSemaphoreui64NVX glSignalSemaphoreui64NVX u n a a -- void	( signalGpu fenceObjectCount semaphoreArray fenceValueArray -- )
\ c-function glWaitSemaphoreui64NVX glWaitSemaphoreui64NVX u n a a -- void	( waitGpu fenceObjectCount semaphoreArray fenceValueArray -- )
\ c-function glClientWaitSemaphoreui64NVX glClientWaitSemaphoreui64NVX n a a -- void	( fenceObjectCount semaphoreArray fenceValueArray -- )
...
\ c-function glGetMemoryObjectDetachedResourcesuivNV glGetMemoryObjectDetachedResourcesuivNV u u n n a -- void	( memory pname first count params -- )
\ c-function glResetMemoryObjectParameterNV glResetMemoryObjectParameterNV u u -- void	( memory pname -- )
\ c-function glTexAttachMemoryNV glTexAttachMemoryNV u u d -- void	( target memory offset -- )
\ c-function glBufferAttachMemoryNV glBufferAttachMemoryNV u u d -- void	( target memory offset -- )
\ c-function glTextureAttachMemoryNV glTextureAttachMemoryNV u u d -- void	( texture memory offset -- )
\ c-function glNamedBufferAttachMemoryNV glNamedBufferAttachMemoryNV u u d -- void	( buffer memory offset -- )
\ c-function glDrawMeshTasksNV glDrawMeshTasksNV u u -- void	( first count -- )
\ c-function glDrawMeshTasksIndirectNV glDrawMeshTasksIndirectNV n -- void	( indirect -- )
\ c-function glMultiDrawMeshTasksIndirectNV glMultiDrawMeshTasksIndirectNV n n n -- void	( indirect drawcount stride -- )
\ c-function glMultiDrawMeshTasksIndirectCountNV glMultiDrawMeshTasksIndirectCountNV n n n n -- void	( indirect drawcount maxdrawcount stride -- )
...
\ c-function glScissorExclusiveNV glScissorExclusiveNV n n n n -- void	( x y width height -- )
\ c-function glScissorExclusiveArrayvNV glScissorExclusiveArrayvNV u n a -- void	( first count v -- )
...
\ c-function glBindShadingRateImageNV glBindShadingRateImageNV u -- void	( texture -- )
\ c-function glGetShadingRateImagePaletteNV glGetShadingRateImagePaletteNV u u a -- void	( viewport entry rate -- )
\ c-function glGetShadingRateSampleLocationivNV glGetShadingRateSampleLocationivNV u u u a -- void	( rate samples index location -- )
\ c-function glShadingRateImageBarrierNV glShadingRateImageBarrierNV u -- void	( synchronize -- )
\ c-function glShadingRateImagePaletteNV glShadingRateImagePaletteNV u u n a -- void	( viewport first count rates -- )
\ c-function glShadingRateSampleOrderNV glShadingRateSampleOrderNV u -- void	( order -- )
\ c-function glShadingRateSampleOrderCustomNV glShadingRateSampleOrderCustomNV u u a -- void	( rate samples locations -- )
...
\ c-function glVDPAURegisterVideoSurfaceWithPictureStructureNV glVDPAURegisterVideoSurfaceWithPictureStructureNV a u n a u -- n	( vdpSurface target numTextureNames textureNames isFrameStructure -- )
