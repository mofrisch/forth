...
c-callback png_rw_ptr: a a n -- void	( <noname> <noname> <noname> -- )
...
c-callback png_malloc_ptr: a n -- a	( <noname> <noname> -- )
...
c-function png_sig_cmp png_sig_cmp a n n -- n	( sig start num_to_check -- )
...
c-function png_get_compression_buffer_size png_get_compression_buffer_size a -- n	( png_ptr -- )
c-function png_set_compression_buffer_size png_set_compression_buffer_size a n -- void	( png_ptr size -- )
c-function png_longjmp png_longjmp a n -- void	( png_ptr val -- )
c-function png_write_sig png_write_sig a -- void	( png_ptr -- )
c-function png_write_chunk png_write_chunk a a a n -- void	( png_ptr chunk_name data length -- )
c-function png_write_chunk_start png_write_chunk_start a a u -- void	( png_ptr chunk_name length -- )
c-function png_write_chunk_data png_write_chunk_data a a n -- void	( png_ptr data length -- )
...
\ c-function png_info_init_3 png_info_init_3 a n -- void	( info_ptr png_info_struct_size -- )
...
c-function png_malloc png_malloc a n -- a	( png_ptr size -- )
c-function png_calloc png_calloc a n -- a	( png_ptr size -- )
c-function png_malloc_warn png_malloc_warn a n -- a	( png_ptr size -- )
...
c-function png_get_rowbytes png_get_rowbytes a a -- n	( png_ptr info_ptr -- )
