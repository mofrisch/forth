...
int main( int argc, char **argv )
{
	...
	swigPrint( "c-library va_glx\ns\" va_glx\" add-lib\n\\c #include <va/va_glx.h>", "( none )", "( none )" );

	swigNewline();

	swigComment("------===< functions >===-------\n");
	swigFunction( "c-function vaGetDisplayGLX vaGetDisplayGLX a -- a", "FUNCTION: vaGetDisplayGLX ( dpy -- a )", "EXTERN: \"C\" void * vaGetDisplayGLX( void * dpy );", "	( dpy -- )" );
	swigFunction( "c-function vaCreateSurfaceGLX vaCreateSurfaceGLX a n n a -- n", "FUNCTION: vaCreateSurfaceGLX ( dpy target texture gl_surface -- n )", "EXTERN: \"C\" n vaCreateSurfaceGLX( void * dpy, n target, n texture, void * gl_surface );", "	( dpy target texture gl_surface -- )" );
	swigFunction( "c-function vaDestroySurfaceGLX vaDestroySurfaceGLX a a -- n", "FUNCTION: vaDestroySurfaceGLX ( dpy gl_surface -- n )", "EXTERN: \"C\" n vaDestroySurfaceGLX( void * dpy, void * gl_surface );", "	( dpy gl_surface -- )" );
	swigFunction( "c-function vaCopySurfaceGLX vaCopySurfaceGLX a a n u -- n", "FUNCTION: vaCopySurfaceGLX ( dpy gl_surface surface flags -- n )", "EXTERN: \"C\" n vaCopySurfaceGLX( void * dpy, void * gl_surface, n surface, int flags );", "	( dpy gl_surface surface flags -- )" );
